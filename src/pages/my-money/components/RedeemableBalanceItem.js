...
const RedeemableBalanceItem = React.memo(({
  style,
  ledgerEntry,
}) => {
  ...
  const ledgerEntryData = useFragment(graphql`
    fragment RedeemableBalanceItem_ledgerEntry on LedgerEntry {
      id
      date
      description
      value {
...
RedeemableBalanceItem.displayName = 'RedeemableBalanceItem';

export default RedeemableBalanceItem;
